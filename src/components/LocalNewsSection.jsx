...
export default function LocalNewsSection({ articles, lang, onSelectArticle }) {
  ...
  return (
    <section id="section-local" className="section-pure-white" style={{ padding: '3.25rem 0' }}>
      <div className="container">
        ...
        <div style={{
          ...
          >
            {lang === 'ar' ? 'عرض جميع الأخبار المحلية' : 'بینینی هەموو هەواڵە ناوخۆییەکان'}
